...
_FEATURE_WORDS = {
    ...
    "nl": {
        ...
        "een", "elk", "en", "er", "gegeven", "gehele", "getal", "getallen", "heeft",
        "het", "in", "is", "met", "niet", "of", "op", "positieve", "voor", "waar",
...
_MK_DISTINCTIVE_RE = re.compile(r"[ЃѓЅѕЈјЉљЊњЌќЏџ]")
...
__all__ = ["DETECTOR_VERSION", "detect_source_lang", "should_passthrough"]
