...
# A-003｜Bounded Symmetric Cubic System
...
1. 把方程改写为只含 $x+y$ 与 $xy$ 的关系，再用实数 $x,y$ 必须满足的判别约束和题给乘积界筛选。
2. 设 $a=x+y,b=xy$，先由原式表示出 $b$；同时使用 $a^2≥4b$ 与 $|b|≤25/9$，把问题化为关于 $a$ 的三个符号条件。
3. 分别因式分解 $a^2/4-b$、$b-25/9$ 与 $b+25/9$，取三者允许区间的交集；留下的情形都会使 $a^2=4b$，于是由二次方程判别式确定 $x,y$。
