...
| 维度 | 现状 | 下一步 |
| --- | --- | --- |
| 核验可信度 | 144 题全部溯源或程序互证；ISL 2024 尚余 4 项待官方解答终审（C3 证明、N1 完备性、N2 分类、C5 比对，见 docs/sources/README.md） | PDF 落库后终审四项；lint 加入链接可达性检查 |
| 覆盖广度 | 144 题 | 阶段一 500 题：优先补 ISL 近十年（PDF 弹药库就绪后逐年铺开）、高联加试、APMO/EGMO |
