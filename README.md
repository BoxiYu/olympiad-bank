...
按「知识点 × 难度」双维组织的中文奥数题库 + 训练系统。当前 **158 道已核实真题**，覆盖小学/初中 → 高联/CMO → AMC-AIME-USAMO → IMO/ISL 四大体系。架构按 10000 题规模设计。训练用法见 `docs/教练手册.md`。
...
| 维度 | 现状 | 下一步 |
| --- | --- | --- |
| 核验可信度 | 158 题全部溯源（题面/答案官方 sourced）；ISL 2024 五项终审关闭；新入 14 题解法要点为教练梗概 | lint 加入链接可达性检查；教练梗概逐步比对官方证明全文 |
| 覆盖广度 | 158 题；ISL 2024 除 G 板块余题（G3 起）外全部入库（25 条相关条目，含 IMO P1/P2/P3/P4/P5/P6 全六题） | 阶段一 500 题：ISL 2024 G 板块收尾、2015–2023 逐年跑抽取管线、高联加试、APMO/EGMO |
